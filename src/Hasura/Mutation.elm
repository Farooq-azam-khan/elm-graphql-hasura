...
delete_todos requiredArgs____ object____ =
    Object.selectionForCompositeField "delete_todos" [ Argument.required "where" requiredArgs____.where_ Hasura.InputObject.encodeTodos_bool_exp ] object____ (identity >> Decode.nullable)
...
delete_todos_by_pk :
    ...
    -> SelectionSet (Maybe decodesTo) RootMutation
delete_todos_by_pk requiredArgs____ object____ =
    Object.selectionForCompositeField "delete_todos_by_pk" [ Argument.required "id" requiredArgs____.id Encode.int ] object____ (identity >> Decode.nullable)
...
insert_todos :
    ...
    -> SelectionSet decodesTo Hasura.Object.Todos_mutation_response
    -> SelectionSet (Maybe decodesTo) RootMutation
insert_todos fillInOptionals____ requiredArgs____ object____ =
    let
        filledInOptionals____ =
            fillInOptionals____ { on_conflict = Absent }

        optionalArgs____ =
            [ Argument.optional "on_conflict" filledInOptionals____.on_conflict Hasura.InputObject.encodeTodos_on_conflict ]
                |> List.filterMap identity
    in
    Object.selectionForCompositeField "insert_todos" (optionalArgs____ ++ [ Argument.required "objects" requiredArgs____.objects (Hasura.InputObject.encodeTodos_insert_input |> Encode.list) ]) object____ (identity >> Decode.nullable)
...
insert_todos_one :
    ...
    -> SelectionSet decodesTo Hasura.Object.Todos
    -> SelectionSet (Maybe decodesTo) RootMutation
insert_todos_one fillInOptionals____ requiredArgs____ object____ =
    let
        filledInOptionals____ =
            fillInOptionals____ { on_conflict = Absent }
        ...
        optionalArgs____ =
            [ Argument.optional "on_conflict" filledInOptionals____.on_conflict Hasura.InputObject.encodeTodos_on_conflict ]
                |> List.filterMap identity
    in
    Object.selectionForCompositeField "insert_todos_one" (optionalArgs____ ++ [ Argument.required "object" requiredArgs____.object Hasura.InputObject.encodeTodos_insert_input ]) object____ (identity >> Decode.nullable)
...
update_todos :
    ...
    -> SelectionSet decodesTo Hasura.Object.Todos_mutation_response
    -> SelectionSet (Maybe decodesTo) RootMutation
update_todos fillInOptionals____ requiredArgs____ object____ =
    let
        filledInOptionals____ =
            fillInOptionals____ { set_ = Absent }

        optionalArgs____ =
            [ Argument.optional "_set" filledInOptionals____.set_ Hasura.InputObject.encodeTodos_set_input ]
                |> List.filterMap identity
    in
    Object.selectionForCompositeField "update_todos" (optionalArgs____ ++ [ Argument.required "where" requiredArgs____.where_ Hasura.InputObject.encodeTodos_bool_exp ]) object____ (identity >> Decode.nullable)
...
update_todos_by_pk :
    ...
    -> SelectionSet decodesTo Hasura.Object.Todos
    -> SelectionSet (Maybe decodesTo) RootMutation
update_todos_by_pk fillInOptionals____ requiredArgs____ object____ =
    let
        filledInOptionals____ =
            fillInOptionals____ { set_ = Absent }
        ...
        optionalArgs____ =
            [ Argument.optional "_set" filledInOptionals____.set_ Hasura.InputObject.encodeTodos_set_input ]
                |> List.filterMap identity
    in
    Object.selectionForCompositeField "update_todos_by_pk" (optionalArgs____ ++ [ Argument.required "pk_columns" requiredArgs____.pk_columns Hasura.InputObject.encodeTodos_pk_columns_input ]) object____ (identity >> Decode.nullable)
...
update_users fillInOptionals____ requiredArgs____ object____ =
    let
        ...
        optionalArgs____ =
            [ Argument.optional "_set" filledInOptionals____.set_ Hasura.InputObject.encodeUsers_set_input ]
                |> List.filterMap identity
    in
    Object.selectionForCompositeField "update_users" (optionalArgs____ ++ [ Argument.required "where" requiredArgs____.where_ Hasura.InputObject.encodeUsers_bool_exp ]) object____ (identity >> Decode.nullable)
    ...
    let
        ...
        optionalArgs____ =
            [ Argument.optional "_set" filledInOptionals____.set_ Hasura.InputObject.encodeUsers_set_input ]
                |> List.filterMap identity
    in
    Object.selectionForCompositeField "update_users_by_pk" (optionalArgs____ ++ [ Argument.required "pk_columns" requiredArgs____.pk_columns Hasura.InputObject.encodeUsers_pk_columns_input ]) object____ (identity >> Decode.nullable)
