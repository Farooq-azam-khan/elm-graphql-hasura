...
module Hasura.Object.Todos_mutation_response exposing (..)
...
returning :
    ...
    -> SelectionSet (List decodesTo) Hasura.Object.Todos_mutation_response
returning object____ =
    Object.selectionForCompositeField "returning" [] object____ (identity >> Decode.list)
