...
-}
online_users :
    (OnlineUsersOptionalArguments -> OnlineUsersOptionalArguments)
    -> SelectionSet decodesTo Hasura.Object.Online_users
    -> SelectionSet (List decodesTo) RootSubscription
online_users fillInOptionals____ object____ =
    let
        filledInOptionals____ =
            fillInOptionals____ { distinct_on = Absent, limit = Absent, offset = Absent, order_by = Absent, where_ = Absent }

        optionalArgs____ =
            [ Argument.optional "distinct_on" filledInOptionals____.distinct_on (Encode.enum Hasura.Enum.Online_users_select_column.toString |> Encode.list), Argument.optional "limit" filledInOptionals____.limit Encode.int, Argument.optional "offset" filledInOptionals____.offset Encode.int, Argument.optional "order_by" filledInOptionals____.order_by (Hasura.InputObject.encodeOnline_users_order_by |> Encode.list), Argument.optional "where" filledInOptionals____.where_ Hasura.InputObject.encodeOnline_users_bool_exp ]
                |> List.filterMap identity
    in
    Object.selectionForCompositeField "online_users" optionalArgs____ object____ (identity >> Decode.list)
...
-}
todos_by_pk :
    TodosByPkRequiredArguments
    -> SelectionSet decodesTo Hasura.Object.Todos
    -> SelectionSet (Maybe decodesTo) RootSubscription
todos_by_pk requiredArgs____ object____ =
    Object.selectionForCompositeField "todos_by_pk" [ Argument.required "id" requiredArgs____.id Encode.int ] object____ (identity >> Decode.nullable)
...
users fillInOptionals____ object____ =
    let
        ...
        optionalArgs____ =
            [ Argument.optional "distinct_on" filledInOptionals____.distinct_on (Encode.enum Hasura.Enum.Users_select_column.toString |> Encode.list), Argument.optional "limit" filledInOptionals____.limit Encode.int, Argument.optional "offset" filledInOptionals____.offset Encode.int, Argument.optional "order_by" filledInOptionals____.order_by (Hasura.InputObject.encodeUsers_order_by |> Encode.list), Argument.optional "where" filledInOptionals____.where_ Hasura.InputObject.encodeUsers_bool_exp ]
                |> List.filterMap identity
    in
    Object.selectionForCompositeField "users" optionalArgs____ object____ (identity >> Decode.list)
...
users_by_pk requiredArgs____ object____ =
    Object.selectionForCompositeField "users_by_pk" [ Argument.required "id" requiredArgs____.id Encode.string ] object____ (identity >> Decode.nullable)
